<template>
  <div class="flex h-screen overflow-hidden">
    ...
    <div class="w-full md:w-1/2 flex items-center justify-center bg-white overflow-y-auto">
      <v-sheet width="100%" max-width="440" theme="light" class="px-6 px-sm-10 py-10" elevation="0">
        ...
        <v-form ref="formRef" @submit.prevent="handleLogin">
          <v-text-field v-model="form.email" label="E-mail" type="email" placeholder="seu@email.com"
          ...
          <v-btn type="submit" color="#FF002B" variant="flat" size="large" block :loading="isLoading"
            :disabled="isLoading">
            Entrar
          </v-btn>
        </v-form>
